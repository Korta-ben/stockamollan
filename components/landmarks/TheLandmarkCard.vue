<template>
  <NuxtLink :to="{ name: 'sevardheter-slug', params: { slug: landmark.slug } }" class="bg-stLightGreen text-xl leading-6 pb-5 rounded-b-xl lg:flex lg:place-content-center lg:pb-0">
